...
The project (all versions) and its developers are not responsible for the correctness of the models, and any consequences arising from the use of the exported models.
